...
REQUIRED_ROOT = ['START_HERE.md','START_HERE.ko-KR.md','AGENTS.md','CLAUDE.md','shared/common-contract.md','shared/common-contract.ko-KR.md','shared/novice-guidance-protocol.md','shared/novice-guidance-protocol.ko-KR.md','templates/PROJECT_BRIEF.md','templates/PROJECT_INDEX.md','templates/SESSION_HANDOFF.md','templates/DECISIONS.md','templates/AUTHORIZATIONS.md','templates/stage-deliverable-template.md','provenance/README.md','research-extension/README.md','evals/novice-cases-0.5.0.md','evals/korean-cases-0.5.1.json','evals/check_korean_support.py','evals/korean-validation-0.5.1.md','evals/creative-chain-cases-0.6.0.json','evals/check_creative_chain_0_6_0.py','evals/validation-0.6.0.md','evals/validation-0.6.0.ko-KR.md']
REQUIRED_ROOT += ['evals/performance-chain-cases-0.7.0.json','evals/performance-chain-regression-0.7.0.json','evals/check_performance_chain_0_7_0.py','evals/validation-0.7.0.md','evals/validation-0.7.0.ko-KR.md']
